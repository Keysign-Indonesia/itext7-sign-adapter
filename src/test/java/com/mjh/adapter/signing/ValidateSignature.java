...
//            pdfByte = IOUtils.toByteArray(this.getClass().getResourceAsStream("signedFile_keysigndesktop.pdf"));
//
...
//    {
//        System.out.println("\nValidate signature");
//        try ( InputStream resource = new FileInputStream(new File("/home/jimbonk2000/Desktop/DemoDesktop/LoremIpsum_usecase_03_02.pdf")))
//        {
//            Assert.assertTrue(validatePdfSignaturesImproved(IOUtils.toByteArray(resource), "/home/jimbonk2000/Desktop/DemoDesktop/LoremIpsum_usecase_03_02.cms"));
//        }
//    }
//
//    boolean validatePdfSignaturesImproved(byte[] pdfByte, String signatureFileName) throws IOException, CMSException, OperatorCreationException, GeneralSecurityException
//    {
//        boolean result = true;
...
//                    Files.write(new File(fileName).toPath(), signatureAsBytes);
